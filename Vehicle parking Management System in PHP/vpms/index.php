...
<head>
    ...
    <title>Parko Friend | Online Parking slot booking system</title>
...
<body id="page-top">
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="index.php">ParkoFriend</a>
    ...
    <script src="js/map_work.js"></script>
